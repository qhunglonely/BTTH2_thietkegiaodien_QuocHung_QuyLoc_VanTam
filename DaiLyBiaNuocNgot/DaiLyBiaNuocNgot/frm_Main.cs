...
namespace DaiLyBiaNuocNgot
{
    public partial class frm_Main : Form
    {
        ...
        private void frm_Main_Load(object sender, EventArgs e)
        {
          ...
          SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-BUR510J\SQLEXPRESS;Initial Catalog=QL_DaiLyBiaNuocNgot;Integrated Security=True");
        ...
        private void buttonItem15_Click(object sender, EventArgs e)
        {
            ...
            frm_Nhanvien f_NHANVIEN = new frm_Nhanvien();
